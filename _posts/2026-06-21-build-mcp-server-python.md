...
lang: ja
image:
  path: /assets/images/posts/2026-06-21-build-mcp-server-python/eyecatch.png
  alt: 小さな機械がノート棚から一覧カードとノートを取り出し書き込み口が塞がれている紙コラージュ風イラスト
---
...
{% include mcp-series-index.html current=5 %}
