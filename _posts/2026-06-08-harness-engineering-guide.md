...
![ハーネスの構造図。ハーネスという外枠の中に CLAUDE.md / AGENTS.md、Hooks、Permissions、Tool Surface の4層が積まれ、その下に双方向の矢印を挟んでモデル / LLM、さらに下に Evaluation が置かれている](/assets/images/posts/2026-06-08-harness-engineering-guide/harness-structure.svg){: .chart}
