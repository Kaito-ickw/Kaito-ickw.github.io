...
Constitutional AI をどこまで踏み込んで作られたモデルなのかという点では、[Claude Mythos（Fable）とは何か]({% post_url 2026-06-10-claude-mythos-fable %})で扱ったモデルが分かりやすい例になる。

公開済みのモデルを後から目的に合わせて鍛え直す手段も出てきている。仕組みは[既存LLMを鍛え直すTraining API「Tinker」]({% post_url 2026-07-23-tinker-training-api %})で見た。
