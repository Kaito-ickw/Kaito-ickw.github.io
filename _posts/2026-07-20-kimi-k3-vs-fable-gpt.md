...
7月時点から状況が動いている。Artificial Analysisは指数を改定し（v4.1.1、8月20日）、K3のスコアは60になった。GLM-5.3と並び、オープンウェイトでは引き続き首位である。またClaude Opus 5などさらに新しいフロンティアモデルも登場しているため、本文の表は現在のリーダーボードではなく7月のフロンティアのスナップショットとして読んでほしい。K3のAPI価格は$3 / $15のまま変わっていない。
