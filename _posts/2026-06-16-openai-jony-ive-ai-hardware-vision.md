...
2026年6月末から7月初旬にかけての報道では、カメラを搭載したスマートスピーカー型（価格帯$200〜$300）が最初の製品の主軸とされている。Sweetpea（イヤフォン型）とGumdrop（ペン型）はこの主製品に続く後続製品として位置づけられているという。2月の「デスクに置くコアデバイス」という説明とも整合しており、形状の方向性は絞られてきている可能性がある。
...
2026年6月26日、AppleでApple Vision Proのハードウェアエンジニアリングを7年間率い、直近はAppleスマートグラス開発の責任者を務めていたPaul Meadeが、OpenAIのハードウェア部門に参加したことが報じられた。Jony Ive自身もApple出身であり、ハードウェアチームへのApple人材の集中が続いている。
...
| 検討された形状 | カメラ内蔵スマートスピーカー（$200〜$300）が主軸。イヤフォン型「Sweetpea」、ペン型「Gumdrop」は後続製品の位置づけ |
...
ここまでの情報はすべて2026年7月初旬時点の報道に基づく。OpenAIは正式な製品発表をまだ行っておらず、形状や発売時期は今後さらに変わる可能性がある。
