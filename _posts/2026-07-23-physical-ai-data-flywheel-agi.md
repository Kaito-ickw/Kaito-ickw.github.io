...
lang: ja
image:
  path: /assets/images/posts/2026-07-23-physical-ai-data-flywheel-agi/eyecatch.png
  alt: 切り紙で表現したロボットが壺に働きかけ、行動と観測の循環から学ぶ様子
---
...
![LLMやVLMによる指示理解から、限定タスクでの成立、実世界データの蓄積、世界モデルとの組み合わせを経て記号接地や自己改善へつながる流れ](/assets/images/posts/2026-07-23-physical-ai-data-flywheel-agi/data-flywheel.svg){: .chart}
