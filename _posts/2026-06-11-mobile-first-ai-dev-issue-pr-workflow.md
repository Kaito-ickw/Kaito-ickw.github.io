...
lang: ja
image:
  path: /assets/images/posts/2026-06-11-mobile-first-ai-dev-issue-pr-workflow/eyecatch.png
  alt: スマートフォンから依頼を送り生成物を承認してゲートを開く紙工作
---
...
スマホから直接エージェントを叩く方向で組む選択肢もある。そちらの構成は[Android から Claude Code を使うパターンと選び方]({% post_url 2026-06-09-claude-code-android-patterns %})で比較している。
